...
import com.HultonHotelReservation.dbaccess.Discount;
...
public class DBAccess  {
	...
	private static  void populateRooms(Connection connection, JSONObject jsondb, JSONObject countries) {
		String hotelDbQuery = "select h.hotel_id, h.street, h.city, h.state, h.country, " +
			   ...
			   " FROM HotelAddress h , Room r where r.hotel_id = h.hotel_id" +
				      "  order by h.country, h.state";
	...
	private static void addCountry(JSONObject countries, JSONObject states, JSONObject hotels, JSONObject rooms, String[] fields) {
	  ...
	  "rooms":[
	           {
	        	   ...
	        	   "checkin":"\"2017-12-06\"",
	        	   "checkout":"\"2017-12-04\"",
	        	   "roomBreakfasts":[{"id":1,"count":1}],
	        	   "roomServices":[{"id":1}]
	         }
	    ],
	  	"cardinfo":{"card_owner":"eee","card_no":"eeee","card_type":"3","security_code":"345","expiration_date":"2017-12-05","billing_address":"ddddd"}
      ]
    }
 */
	public static JSONObject reserveRequest(HttpSession session, Connection connection, String request_type,
		...
		int reservationId = reservation.insertRecord(connection);
